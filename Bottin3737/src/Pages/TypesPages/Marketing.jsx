...
function Marketing() {
  ...
  const [filters, setfilters] = useState({
    companyName: '',
    address: '',
    activityField: 'Marketing',
    service: ''
  });
  async function fetchCompanies() {
    const conditions = [];
    conditions.push(where('activityField', '==', 'Marketing'));
  ...
  return (
    <PageTemplate>
      ...
      >
        ...
        <Box sx={{ alignItems: 'center', justifyContent: 'center', zIndex: 1, padding: '50px' }}>
     ...
     <Pagination
          ...
          />
        </Box>   <Box style={{ display: 'flex', justifyContent: 'flex-end', width: '90%' }}>
