...
function InactiveCompanies() {
  ...
  async function fetchAllCompanies() {
    const q = query(collection(db, 'companies'), where('active', '==', false));
    ...
    emailjs
      .send(
        ...
        'template_yqp8edb',
        {
          ...
          message: status == true ? `Account activated` + message : `Account not accepted` + message,
  ...
  return (
    <PageTemplate>
      ...
      <Dialog
        ...
        aria-describedby="alert-dialog-description"
      >
        <DialogTitle id="alert-dialog-title">{t('are you sure you want to refuse this company')} ?</DialogTitle>
        <DialogContent>
          <DialogContentText id="alert-dialog-description">{t('an email will be sent')} </DialogContentText>
          <StyledTextarea
            aria-label="minimum height"
            minRows={3}
            placeholder={t('please provide a rejection reason')}
        ...
        <DialogActions>
          ...
          >
            {t('confirm')}
            {/* <a style={{textDecoration:"none"}} href={`mailto:hayfa.chouchene1@gmail.com`}> {t('confirm')}</a> */}
          </Button>
        </DialogActions>
      </Dialog>
      <Dialog
        ...
        aria-describedby="alert-dialog-description"
      >
        <DialogTitle id="alert-dialog-title">{t('are you sure you want to accept this company')} ?</DialogTitle>
        <DialogContent>
          <DialogContentText id="alert-dialog-description">{t('an activation email will be sent')} </DialogContentText>
          <StyledTextarea
            aria-label="minimum height"
            minRows={3}
            placeholder={t('please provide a rejection reason')}
